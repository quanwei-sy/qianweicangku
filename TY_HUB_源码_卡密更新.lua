...
local Main = WindUI:CreateWindow({
    Title = "<font color='#ff007f'>TY HUB</font>-<font color='#00ffff'>付费</font>",
...
Notify("TY HUB", "作者：权威", "rbxassetid://108228172425291", 3)
...
TitleText.Font = font
TitleText.Text = "             旋转甩飞脚本【汉化作者：权威】"..version
...
CreditText.Text = "原作者: topit 汉化:权威 "
...
local Window = WindUI:CreateWindow({
        Title = "TY HUB<font color='#00FF00'>v2</font>",
...
local WindUI = loadstring(game:HttpGet("https://github.com/Footagesus/WindUI/releases/latest/download/main.lua"))()
local Window = WindUI:CreateWindow({
        Title = "TY HUB-自然灾害<font color='#00FF00'>V2</font>",
...
local Tabs = {
    Main = Window:Section({ Title = "TY HUB自然灾害", Opened = true }),
}
...
local WindUI = loadstring(game:HttpGet("https://github.com/Footagesus/WindUI/releases/latest/download/main.lua"))()
local Window = WindUI:CreateWindow({
        Title = "TY HUB<font color='#00FF00'>模仿者</font>",
